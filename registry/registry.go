...
var (
	...
	clientLimiterReg   reg.Registry[conn.ConnLimiter]       = new(clientLimiterRegistry)
...
func ClientLimiterRegistry() reg.Registry[conn.ConnLimiter] {
	return clientLimiterReg
}
